...
from models.NLinear import NLinear  # Ensure correct import path

# Load arguments
args = Args()
args.model_type = 'NLinear'
...
# Initialize model
model = NLinear(args)  # Correctly instantiated
...
plt.title('Training Loss - Normalized Linear Model')
plt.xlabel('Epoch')
